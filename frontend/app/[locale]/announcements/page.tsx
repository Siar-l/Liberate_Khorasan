...
export default async function AnnouncementsPage({ params }: AnnouncementsPageProps) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-16 md:px-10" dir={isFa ? "rtl" : "ltr"}>
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-3xl leading-7 text-gray-600">
          {isFa
            ...
            : "Follow the latest announcements and updates in this section."}
        </p>
      </header>

      {items.length === 0 ? (
        <p className="rounded-2xl border border-gray-200 bg-gray-50 p-6 text-gray-600">
          {isFa
            ? "هنوز اطلاعیه منتشر شده ای وجود ندارد."
